  ...
  async execute(cmd) {
    ...
    if (section.includes("admin")) {
      helpEmbed.addFields(
        ...
        {name: "/color", value: "```Creates or Updates the User's Role Color\nIf said Role is Protected, a New Role will be Created Above the 🎨 Auto-Palette 🎨 Role```"},
        {name: "/name", value: "```Creates or Updates the User's Role Name\nIf said Role is Protected, a New Role will be Created Above the 🎨 Auto-Palette 🎨 Role```"},
        {name: "/palette and /search", value: "```Updates the Color Role of the User, Unless said Role is Protected```"},
        {name: "/autopalette", value: "```Grants the User the 🎨 Auto-Palette 🎨 Role (if the User's Color Role is Not Protected)```"})
      ...
      helpEmbed.addFields(
        ...
        {name: "¿What Commands does this Affect?", value: "```/autopalette, /palette and /search will __not__ Work if your Color Role is Protected...```"},
      ...
      helpEmbed.addFields(
        ...
        {name: "/color", value: "```Create or Update your Color Role!\nInput a Hexadecimal Color!```"},
        {name: "/name", value: "```Create or Update your Color Role!\nInput the Name you Want!```"},
